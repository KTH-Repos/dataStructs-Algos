...
public abstract class StackTest {
    ...
    public void topExceptionWhenStackIsEmpty() {
       // fail("Not implemented");
        //Assert
        assertThat(emptyStack.top(), equalTo(null));
    ...
    public void popExceptionWhenStackIsEmpty() {
       // fail("Not implemented");
        //Assert
        assertThat(emptyStack.pop(), equalTo(null));
    }
    ...
    public void popFiveTimesDecreasesSizeByFive() {
        ...
        //Assert
        assertThat(originalSize, equalTo(sizeAfterPop + 5));
    ...
    public void pushFiveTimesIncreasesSizeByFive() {
        //fail("Not implemented");
        //Arrange
        int originalSize = emptyStack.size();
        int[] newArray = new int[] {1, 2, 3, 4, 5};

        //Act
        pushArrayToStack(newArray, emptyStack);

        //Assert
        assertThat(emptyStack.size(), equalTo(originalSize + 5));
    }
